...
\\node[anchor=north west,xshift=❰xshift❱mm,yshift=❰yshift❱mm] at (current page.north west){
  ...
  demo = function() {
    ...
    var angle, column, correction, height, i, j, k, len, len1, len2, orientation, page, page_idx, page_nr, ref, ref1, ref2, sheet, side, source_path, template, template_path, tex_target_path, width, xshift, yshift;
