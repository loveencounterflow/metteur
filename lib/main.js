...
\\node[anchor=north west,xshift=❰xshift❱mm,yshift=❰yshift❱mm] at (current page.north west){%
  ...
  Metteur = class Metteur extends GUY.props.Strict_owner {
    ...
    //---------------------------------------------------------------------------------------------------------
    _impose(cfg) {
      var Q, _column, _column_idx, _side, _slot_idx, _slot_map, doc_tpl, doc_tpl_path, format, i, j, k, l, len, len1, len2, len3, page_idx, page_nr, pdistro_idx, ref, ref1, ref2, ref3, ref4, ref5, sheet;
