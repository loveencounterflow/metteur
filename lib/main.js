...
\\node[anchor=north west,xshift=❰xshift❱mm,yshift=❰yshift❱mm] at (current page.north west){%
  ...
  Metteur = class Metteur extends GUY.props.Strict_owner {
    ...
    async _generate_overlay(cfg) {
      var doc, font, fontBytes, font_path, height, i, page, pos_nr, poscount, quire_nr, ref, size, slot_nr, width, x, y;
...
//.......................................................................................................
      for (pos_nr = i = 1, ref = poscount; (1 <= ref ? i <= ref : i >= ref); pos_nr = 1 <= ref ? ++i : --i) {
        ...
        x = H.pt_from_mm(10);
        y = H.pt_from_mm(10);
        slot_nr = (modulo(pos_nr - 1, cfg.layout.pps)) + 1;
        switch (slot_nr) {
          case 1:
            quire_nr++;
