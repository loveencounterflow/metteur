(function() {
  'use strict';
  var FS, GUY, Metteur, PATH, Template, debug, demo, echo, freeze, get, has, help, hide, info, isa, layout, misfit, page_tpl, resolve, rpr, types, urge, warn, whisper;
...
\\node[anchor=north west,xshift=❰xshift❱mm,yshift=❰yshift❱mm] at (current page.north west){%
  ...
  Metteur = class Metteur extends GUY.props.Strict_owner {
    ...
    //---------------------------------------------------------------------------------------------------------
    impose(cfg) {
      var Q, _column, _page_idx, _page_nr, _side, doc_tpl, doc_tpl_path, format, i, j, k, len, len1, len2, ref, ref1, ref2, sheet;
