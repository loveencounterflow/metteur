...
\\node[anchor=north west,xshift=❰xshift❱mm,yshift=❰yshift❱mm] at (current page.north west){%
  ...
  Metteur = class Metteur extends GUY.props.Strict_owner {
    ...
    _impose(cfg) {
      ...
      var Q, _column, _column_idx, _side_name, _slot_idx, _slot_map, column_width, doc_tpl, doc_tpl_path, format, i, j, k, len, len1, len2, pdistro_idx, ref, ref1, ref2, ref3, row_height;
