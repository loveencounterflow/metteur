...
\\node[anchor=north west,xshift=❰xshift❱mm,yshift=❰yshift❱mm] at (current page.north west){%
  ...
  Metteur = class Metteur extends GUY.props.Strict_owner {
    ...
    //---------------------------------------------------------------------------------------------------------
    xxx() {
      var Q, _column, _page_idx, _page_nr, _side, correction, doc_template, doc_tpl, format, i, j, k, len, len1, len2, orientation, page, page_tpl, ref, ref1, ref2, sheet, source_path, template_path, tex_target_path;
