(function() {
  'use strict';
  var $$, CP, FS, GUY, H, MIXA, Metteur, PATH, _run_tex, blue, debug, deep_copy, digest_from_path, echo, fetch_pagedistro, fetch_pdf_info, grey, help, info, isa, lime, mkdirp, new_hash, path_from_executable_name, resolve, rpr, run_impose, run_tex_etc, show_cfg, to_width, types, urge, validate, warn, whisper,
